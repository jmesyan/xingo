...
//go test -v github.com\jmesyan\xingo\db\mongo -run ^Test_CommonOperate$
...
//go test -v github.com\jmesyan\xingo\db\mongo -bench ^Benchmark_CommonOperate$
...
//go test -v github.com\jmesyan\xingo\db\mongo -bench ^Benchmark_CommonOperatePP$
